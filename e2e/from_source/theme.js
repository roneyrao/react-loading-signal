...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__demo_components_customTheme_cp__ = __webpack_require__(231);
...
var Local = function (_React$PureComponent) {
  _inherits(Local, _React$PureComponent);
  ...
  function Local() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Local.__proto__ || Object.getPrototypeOf(Local)).call.apply(_ref, [this].concat(args))), _this), _this.state = { active: false }, _temp), _possibleConstructorReturn(_this, _ret);
  }
    ...
    value: function componentWillMount() {
      ...
      store.subscribe(function () {
        ...
        if (Object.prototype.hasOwnProperty.call(state, path)) {
          _this2.setState({ active: state[path] });
        }
      });
    }
  }, {
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](
        ...
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('button', { id: 'load', onClick: function onClick() {
            return store.dispatch(Object(__WEBPACK_IMPORTED_MODULE_4__demo_actions__["b" /* load */])(path));
          } }),
        ...
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_6_FlexLoading__["b" /* LocalLoading */], _extends({}, this.state, { theme: __WEBPACK_IMPORTED_MODULE_7__demo_components_customTheme_cp__["a" /* default */] }))
      );
    }
  }]);
...
var TxtTheme = function (_Comp) {
  _inherits(TxtTheme, _Comp);
  ...
  function TxtTheme() {
    ...
    _classCallCheck(this, TxtTheme);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TxtTheme.__proto__ || Object.getPrototypeOf(TxtTheme)).call.apply(_ref, [this].concat(args))), _this), _this.symLen = _this.constructor.Symbols.length, _this.symIndex = 0, _this.state = { symbol: '' }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(TxtTheme, [{
    key: 'clearTimer',
    ...
    value: function startSpinning() {
      ...
      this.timer = window.setInterval(function () {
        _this2.symIndex = (_this2.symIndex + 1) % _this2.symLen;
        _this2.setState({ symbol: _this2.constructor.Symbols[_this2.symIndex] });
      }, 200);
    }
  }, {
...
TxtTheme.Symbols = ['--', '\\', '|', '/'];
/* harmony default export */ __webpack_exports__["a"] = (TxtTheme);
