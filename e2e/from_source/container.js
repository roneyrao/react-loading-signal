...
var Local = function (_React$Component) {
  ...
  function Local() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Local.__proto__ || Object.getPrototypeOf(Local)).call.apply(_ref, [this].concat(args))), _this), _this.state = { button: null, container: null, active: false }, _this.removeContainer = function () {
      _this.setState({ container: false });
    }, _this.restoreContainer = function () {
      _this.setState({ container: undefined });
  ...
  _createClass(Local, [{
    ...
    value: function componentWillMount() {
      ...
      store.subscribe(function () {
        ...
        if (Object.prototype.hasOwnProperty.call(state, path)) {
          _this2.setState({ button: _this2.btn, container: _this2.box, active: state[path] });
        }
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](
        'div',
        null,
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('div', { id: 'box', ref: function ref(box) {
            _this3.box = box;
          } }),
        ...
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('button', { id: 'removeContainer', onClick: this.removeContainer }),
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]('button', { id: 'restoreContainer', onClick: this.restoreContainer }),
